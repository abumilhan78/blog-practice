...
<html>
  ...
  <body>
    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="../assets/template/admin/distribution/img/avatar-7.jpg" alt="person" class="img-fluid rounded-circle">
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <!-- Languages dropdown    -->
                <li class="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="../assets/template/admin/distribution/img/flags/16/GB.png" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
                  <ul aria-labelledby="languages" class="dropdown-menu">
                    <li><a rel="nofollow" href="#" class="dropdown-item"> <img src="../assets/template/admin/distribution/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item"> <img src="../assets/template/admin/distribution/img/flags/16/FR.png" alt="English" class="mr-2"><span>French                                                         </span></a></li>
                  </ul>
                </li>
                <!-- Log out-->
                    ...
                    <ul class="feed-elements list-unstyled">
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../assets/template/admin/distribution/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../assets/template/admin/distribution/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../assets/template/admin/distribution/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../assets/template/admin/distribution/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="../assets/template/admin/distribution/img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
    ...
    <script src="../assets/template/admin/distribution/js/charts-home.js"></script>
    <!-- Main File-->
